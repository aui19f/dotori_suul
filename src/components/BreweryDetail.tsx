  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="grid gap-2">
        <h2 className="text-3xl">호랑이배꼽양조장(밝은세상영농조합)</h2>
      ...
      <div>
        <ul className="max-w-xl grid gap-4 grid-cols-5 my-8 mx-auto py-4 justify-center border-y">
          ...
          >
            <img src={i_info} alt="" className="size-8 mb-4" />
            <p>정보</p>
          </li>
          <li
            className="mx-auto flex flex-col items-center"
          ...
          >
            <img src={i_drinks} alt="" className="size-8 mb-4" />
            <p>주류</p>
          </li>
          <li
            className="mx-auto flex flex-col items-center"
          ...
          >
            <img src={i_review} alt="" className="size-8 mb-4" />
            <p>리뷰</p>
          </li>
          <li className="mx-auto flex flex-col items-center">
            <img src={i_heart_active} alt="" className="size-8 mb-4" />
            <p>111</p>
          </li>
          <li className="mx-auto flex flex-col items-center">
            <img src={i_bookmark} alt="" className="size-8 mb-4" />
            <p>북마크</p>
          </li>
        </ul>
      </div>
